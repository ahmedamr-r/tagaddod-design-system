...
## Label and Selection Display

The Select component displays the label above the field and shows the currently selected value when an option is chosen.
...
The component automatically displays the selected option's label, making it clear what has been chosen while keeping the original label visible for context.
