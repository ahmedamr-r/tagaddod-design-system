...
### Ultimate Z-Index Test: Drawer → Modal → Select
...
**Testing Hierarchy:**
1. **Drawer Opens** → Z-index: 1020
2. **Modal Opens from Drawer** → Z-index: 1070 (automatic via DrawerContext)
3. **Select Dropdowns in Modal** → Z-index: 2147483647 (automatic modal detection)
...
- Drawer + Modal ✅
- Modal + Select ✅
- Drawer + Modal + Select ✅ (Ultimate test)
- Drawer + Select ✅
