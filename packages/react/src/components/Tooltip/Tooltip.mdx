...
- `--color-bg-overlay-20`: Background color (semi-transparent dark)
...
- `--space-300`: Internal padding (12px)
- `--border-radius-200`: Border radius (8px)
- `--t-line-height-english`: Line height for English text (1.5)
- `--t-line-height-arabic`: Line height for Arabic text (1.2)