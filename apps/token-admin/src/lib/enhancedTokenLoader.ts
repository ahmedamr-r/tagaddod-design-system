...
// Moved imports to conditional usage to prevent client-side bundling errors
import { TokenContext } from '@/components/TokenContextSwitcher';
import { TokenNode, TokenAnalysis } from './tokenAnalyzer';
 ...
 */
function extractReferences(value: string | number): string[] {
