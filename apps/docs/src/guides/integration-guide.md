# Integration Guide (Salvaged from apps/docs-app)

> **Note:** This content was salvaged when sunsetting the separate apps/docs-app. Some steps reference setup files (`nextjs-setup.md`, `vite-setup.md`, etc.) that previously lived under packages/storybook/public/setup-files/ and have since been removed. Review and update before republishing.
